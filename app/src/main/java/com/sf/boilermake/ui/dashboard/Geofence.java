...
//            .build();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // TODO need to add marker with user's location
        LatLng userHome = new LatLng(-34, 151);
        // fix zoom if necessary
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(userHome, 16));
        // remove onmaplongclicklistener
    ...
    private void enableUserLocation() {
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                //display dialog for requesting user for permission to display fine location
